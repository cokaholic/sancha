...
@property (nonatomic, assign) BOOL isUISet;
...
{
    _isUISet = NO;
    _eventDetailData = [[EventDetailData alloc]initWithURL:_detailURL completionHandler:^(NSError *error) {
...
- (void)openWebView
{
    if (_eventDetailData.officialPageURL == nil) {
        return;
    }
